...
:root {
  ...
  --font-nb-international-pro:
    "NB International Pro", ui-sans-serif, system-ui, -apple-system,
    BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif;
  --font-saans-trial:
    "Saans Trial", ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont,
...
- **Sidebar background:** `#ffffff` with `1px #202020` right border
- **Main canvas:** `#f5f5f5`
- **Sidebar nav item (default):** Saans 500 14px `#202020`, padding `8px 16px`, no background
- **Sidebar nav item (active):** `#5757f8` text, `#f5f5f5` background, `8px` radius
- **Top bar:** `#ffffff`, `1px #202020` bottom border, 16px padding, holds page title (NB International 26px) + primary action button

### Stat Card

Displays a single metric (total clicks, links created, etc.)

- White `#ffffff` surface, `1px #202020` border, `8px` radius, `24px` padding
- Label: Saans 500 14px `#333333` uppercase
- Value: NB International 36px weight 500 `#202020`, line-height 1.0, letter-spacing -0.72px
- Delta badge (optional): status pill — green `#22c55e` bg for positive, red `#ef4444` for negative, 9999px radius, 12px Saans 500

### Link Table

- Table container: `#ffffff` surface, `1px #202020` border, `8px` radius, no internal padding
- Header row: `#f5f5f5` background, Saans 700 13px `#333333` uppercase, `12px 16px` cell padding, `1px #202020` bottom border
- Body row: `#ffffff`, Saans 500 14px `#202020`, `12px 16px` cell padding, `1px #f5f5f5` bottom border (hairline between rows)
- Slug cell: `#5757f8` text (monospace fallback), Saans 500
- Click count cell: NB International 500 `#202020`
- Tag chips: pill shape 9999px radius, `#f5f5f5` background, `1px #202020` border, `2px 8px` padding, Saans 500 12px `#202020`
- Row actions (copy, QR, delete): icon buttons, `#202020` stroke icons, no border, show on row hover

### Analytics Charts (Recharts)

- **Primary series color:** `#5757f8` (line stroke, bar fill)
- **Grid lines:** `#f5f5f5` (1px horizontal only, no verticals)
- **Axis text:** Saans 500 12px `#333333`
- **Tooltip:** `#ffffff` background, `1px #202020` border, `8px` radius, `12px` padding, no shadow
- **Chart container:** `#ffffff` surface, `1px #202020` border, `8px` radius, `24px` padding

### Form Inputs

- Background: `#ffffff`, border: `1px #202020`, radius: `8px`, padding: `10px 16px`
- Label: Saans 700 14px `#202020`, `4px` gap above input
- Placeholder: Saans 500 14px `#333333`
- Focus: border becomes `#5757f8`, no outline/ring
- Error: border `#ef4444`, error message Saans 500 13px `#ef4444` below field

### Primary Button

Violet `#5757f8` fill, white text, `8px` radius, `10px 20px` padding, Saans 500 14px. Arrow suffix `→` optional for CTAs.

### Ghost Button

`#ffffff` or transparent bg, `1px #202020` border, `#202020` text, `8px` radius, `10px 20px` padding.

### Empty State

Centered in content area. NB International 26px `#202020` heading. Saans 500 16px `#333333` subtext. Primary violet button below. No illustration — text only.

### QR Code Display

White `#ffffff` card, `1px #202020` border, `8px` radius, `24px` padding, QR image centered. "Download PNG" ghost button below.
